...
## 1. Polynomials & Fast Fourier Transform (FFT)

### 1.1 Roots of Unity are Roots
...
### 2.1 Cut Property / Greedy Choice
...
### 2.3 Optimal Substructure in Contraction
...
### 2.4 Correctness of Generic MST
...
### 2.8 Advanced Spanning Tree Proofs

#### 2.8.1 Boruvka Cycle-Free Selection
...
#### 2.8.3 KKT Randomized MST Complexity
...
#### 2.9 Fibonacci Heap Amortized Proofs
...
### 3.1 Triangle Inequality (Unweighted)
...
### 3.5 Predecessor Subgraph is a Shortest-Path Tree
...
### 4.3 Edge Classification by Timestamps
...
### 4.5 Topological Sort Correctness
...
### 5.2 Finishing Times Between Components
...
## 6. Shortest Paths Basics

### 6.1 Subpath of a Shortest Path
...
### 6.2 Triangle Inequality (Weighted)
...
### 6.3 Upper-Bound Property (Weighted)
...
### 6.6 Unreachable Vertices Remain Infinite
...
### 7.1 Topological Order Relaxes Paths in Sequence
...
### 8.1 Any Simple Path Has at Most |V|-1 Edges
...
### 10.1 Intermediate Vertex Recursion
...
### 10.2 Negative Cycle Detection in Floyd-Warshall
...
### 11.3 Reconstructing Original Distance
...
### 11.4 Feasible Landmark Potential
...
### 12.1 Distance Relation between G and G'
...
### 12.2 Distance Parity Reconstruction
...
### 13.1 Telescoping Potential
*   **Statement:** $w'(u, v) = w(u, v) + p(u) - p(v)$ preserves shortest paths.
*   **Proof:** By the same telescoping algebra as Johnson's reweighting, the weight of any path $P$ from $s$ to $t$ shifts by $p(s) - p(t)$, which is constant for all paths. Thus, the shortest path remains unchanged. $\blacksquare$

### 13.2 Admissibility
*   **Statement:** If $p(u) \le \delta(u, t)$, A* is guaranteed to find a shortest path.
*   **Proof:** Since $p(u) \le \delta(u, t)$, the reweighted edge weights satisfy:
    $$w'(u, v) = w(u, v) + p(u) - p(v) \ge w(u, v) + \delta(u, t) - \delta(v, t) \ge 0$$ (by Triangle Inequality).
    Since all reweighted edge weights are non-negative, Dijkstra's search on $w'$ is optimal, ensuring A* is correct. $\blacksquare$

### 13.3 Pruning Expensive Vertices
...
### 13.4 Perfect Potential
*   **Statement:** If $p(u) = \delta(u, t)$, A* visits only vertices on a shortest path.
*   **Proof:** Under this potential, the reweighted cost of any edge $(u, v)$ on a shortest path is $w'(u, v) = w(u, v) + \delta(u, t) - \delta(v, t) = 0$. For any other edge, it is positive. The algorithm will follow the 0-weight edges directly to the destination. $\blacksquare$
...
### 15.1 Augmenting Residual Flows
...
### 16.1 Monotonicity of Source Distances
...
### 16.2 Monotonicity of Sink Distances
...
### 16.4 Saturated Edges Do Not Return in Phase
...
### 16.5 Number of Iterations (Edmonds-Karp)
...
### 17.1 Blocking Flow Increases Distance
...
### 18.1 Matching-to-Flow Correspondence
...
### 18.2 Vertex-Disjoint Augmenting Paths
...
### 18.3 Phase Bound After Long Paths
...
## 19. BMM & Transitive Closure

### 19.1 Boolean Exponentiation Meaning
...
### 19.2 Self-Loops Convert 'Up to k' to 'Exactly k'
...
### 19.3 BMM to Transitive Closure (With Log Factor)
...
## 21. Randomized Algorithms Basics

### 21.1 Linearity of Expectation
...
## 22. Randomized Quicksort

### 22.1 Pairwise Comparison Probability
...
### 22.3 Paranoid QuickSort Expected Runtime
...
## 23. Distributed Symmetry Breaking

### 23.1 Anonymous Leader Election
...
### 23.2 Distributed $2\Delta$-Coloring
...
### 23.3 Distributed Symmetry Breaking via Polynomial ID Ranges
...
## 24. Coupon Collector Properties
...
### 24.2 High Probability Upper Bound
...
## 25. Concentration Bounds Derivations

### 25.1 Chebyshev’s Higher Moments
...
### 25.2 Mill’s Inequality (Gaussian Tail)
...
## 26. Advanced Matrix Reductions

### 26.1 Equivalence of Triangle Detection and BMM
...
### 26.2 Bounded Weight Distance Product via BMM
...
### 26.3 Paths and Boolean Matrix Exponentiation
...
### 26.4 Sparse Triangle Detection (Alon-Yuster-Zwick)
...
## 27. Practice Session Theorems

### 27.1 Unique Minimum Cut Verification
...
### 27.2 Kruskal Edge Sorting Theorem
...
### 27.3 Reverse-Delete MST Algorithm Correctness
...
### 27.4 Randomized Hitting Set Bounds
...
## 28. Linear Programming & Low-Dimensional Seidel's LP

### 28.1 Convexity and Half-Plane Intersections
...
### 28.2 The 2D LP Incremental Step Invariant
...
### 28.3 Inductive Proof of Seidel's LP Recurrence
